                  ...
                  <div className="pt-6 space-y-4" style={{ borderTop: "1px solid var(--color-border)" }}>
                    ...
                    <div className="flex flex-col gap-3 pt-2">
                      <button onClick={handleAddToCart} className="flex items-center justify-center gap-2 w-full px-6 py-3.5 font-semibold text-sm text-white transition-all hover:-translate-y-0.5"
                        style={{ borderRadius: "2rem", backgroundColor: justAdded ? "var(--color-primary-hover)" : "var(--color-primary)" }}
                        onMouseEnter={(e) => { if (!justAdded) e.currentTarget.style.backgroundColor = "var(--color-primary-hover)" }}
                        onMouseLeave={(e) => { if (!justAdded) e.currentTarget.style.backgroundColor = "var(--color-primary)" }}>
