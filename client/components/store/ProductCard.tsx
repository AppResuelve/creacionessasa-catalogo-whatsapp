...
export function ProductCard({ product }) {
  ...
  return (
    <div
      className="group relative overflow-hidden flex flex-col transition-all duration-300 p-3"
      style={{
        borderRadius: "1rem",
      }}
      onMouseEnter={(e) =>
        (e.currentTarget.style.boxShadow = "0 8px 32px rgba(199,135,121,0.12)")
      }
